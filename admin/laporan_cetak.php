...
$sqlsewa = "SELECT booking.*,produk.*,jenis_barang.*,users.* FROM booking,produk,jenis_barang,users WHERE booking.id_produk=produk.id_produk
			AND jenis_barang.id_barang=produk.id_barang AND users.email=booking.email AND booking.status='$stt' 
...
<head>
	...
	<meta name="description" content="rental produk">
	<meta name="author" content="universitas singaperbangsa karawang">

	<title>Cetak Detail Laporan</title>

	<link href="../assets/images/logo-cetak.png" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="../assets/images/logo-cetak.png" alt="logo" width="80" />
						</td>
