...
<head>
	...
	<title>Rental Outdoor | Admin Edit Sewa Barang</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Pengembalian Barang</h2>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=$_GET['id'];
										$sqlsewa = "SELECT booking.*,produk.*,jenis_barang.*,users.* FROM booking,produk,jenis_barang,users WHERE booking.id_produk=produk.id_produk
													AND jenis_barang.id_barang=produk.id_barang AND users.email=booking.email AND booking.kode_booking ='$id'";
										$querysewa = mysqli_query($koneksidb,$sqlsewa);
										$result = mysqli_fetch_array($querysewa);
										$biayaproduk=$result['durasi']*$result['harga'];
										$total = $result['tourguide']+$biayaproduk;
										?>
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="namaproduk" class="form-control" value="<?php echo $result['nama_produk'];?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
												<label class="col-sm-2 control-label">Biaya Tour Guide</label>
												<div class="col-sm-4">
													<input type="text" name="tourguide" class="form-control" value="<?php echo format_rupiah($result['tourguide']);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
											...
											<br/>
											<div class="form-group">
												<label class="col-sm-2 control-label">Biaya Barang</label>
												<div class="col-sm-4">
													<input type="text" name="biayaproduk" class="form-control" value="<?php echo format_rupiah($biayaproduk);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
