...
if($_GET) {
	...
	$sqlsewa = "SELECT booking.*,produk.*,jenis_barang.*,users.* FROM booking,produk,jenis_barang,users WHERE booking.id_produk=produk.id_produk
				AND jenis_barang.id_barang=produk.id_barang AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<table width="100%">
	...
	<tr>
		<td width="20%"><b>Barang</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_barang'];?>, <?php echo $result['nama_produk'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	...
	<tr>
		<td width="20%"><b>Biaya Tour Guide</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['tourguide'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
		<td width="20%"><b>Biaya Barang</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $biayaproduk;?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
