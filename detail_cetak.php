...
$sql1 	= "SELECT booking.*,produk.*, jenis_barang.*, users.* FROM booking,produk,jenis_barang,users WHERE booking.id_produk=produk.id_produk 
			AND jenis_barang.id_barang=produk.id_barang and booking.email=users.email and booking.kode_booking='$kode'";
...
<head>
	...
	<meta name="description" content="rental outdoor">
	<meta name="author" content="universitas singaperbangsa karawang">

	<title>Cetak Detail Sewa</title>

	<link href="assets/images/favicon-icon/apple-touch-icon-72-precomposed.png" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="assets/images/favicon-icon/apple-touch-icon-72-precomposed.png" alt="logo-dkm" width="80" />
						</td>
						<td class="text-center"><h3>Laporan Sewa</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Rental Outdoor</h2></td>
					</tr>
					<tr>
					<td class="text-center">Rukan Mangga Dua Square Blok E No 39, 
												Jl. Gn. Sahari No.1, RT.11/RW.6, Ancol, 
												Kec. Pademangan, Jkt Utara, 
												Daerah Khusus Ibukota Jakarta 14430 </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Produk</td>
						<td>:</td>
						<td><?php echo $result['nama_barang'];echo  ", "; echo $result['nama_produk']; ?></td>
					</tr>
					<tr>
						<td>Tanggal Mulai</td>
						<td>:</td>
					...
					<tr>
						<td>Biaya Produk (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
						<td><?php echo format_rupiah($totalproduk);?></td>
					</tr>
					<tr>
						<td>Biaya Tour Guide (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
