...
if(isset($_POST['submit'])){
	...
	$vid=$_POST['vid'];
//cek
$sql 	= "SELECT kode_booking FROM cek_booking WHERE tgl_booking between '$fromdate' AND '$todate' AND id_produk='$vid' AND status!='Cancel'";
$query 	= mysqli_query($koneksidb,$sql);
if(mysqli_num_rows($query)>0){
		echo " <script> alert ('Produk tidak tersedia di tanggal yang anda pilih, silahkan pilih tanggal lain!'); 
		</script> ";
	}else{
		echo "<script type='text/javascript'> document.location = 'booking_ready.php?vid=$vid&mulai=$fromdate&selesai=$todate&tourguide=$tourguide'; </script>";
	}
}
?>
<!DOCTYPE HTML>
...
return true;
	...
	<div class="col-md-6 col-sm-8">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result['seating']);?> Orang</li>
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
			...
			<label>Tour Guide</label><br/>
				<input type="radio" name="tourguide" value="1" checked>Ya &nbsp;
				<input type="radio" name="tourguide" value="0">Tidak
            </div>
			<br/>			
			<div class="form-group">
